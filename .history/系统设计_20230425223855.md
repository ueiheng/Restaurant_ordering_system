...
系统主要设计了：Admin、Menus、Notice、Orders、Page、Pages、ShoppingCart、Types、User等实体对象，对应的Controller方法有：AdminController、MenusController、NoticeController、OrdersController、PagesController、ShoppingCartController、TypesController、UserController等，
